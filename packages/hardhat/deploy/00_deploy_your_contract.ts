...
const deploySmartLockFactory: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
      On localhost, the deployer account is the one that comes with Hardhat, which is already funded.
...
export default deploySmartLockFactory;

deploySmartLockFactory.tags = ["SmartLockFactory"];
